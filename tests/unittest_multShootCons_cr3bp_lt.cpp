...
BOOST_DATA_TEST_CASE(test_continuity, data::make(lawTypes), lawType){
...
BOOST_DATA_TEST_CASE(test_continuity_equalArc, data::make(lawTypes), lawType){
	SysData_cr3bp_lt sys("earth", "moon", 14);
	ControlLaw_cr3bp_lt law(lawType, 12e-3, 1500);
...
BOOST_DATA_TEST_CASE(test_stateConstraint, data::make(lawTypes), lawType){
...
BOOST_DATA_TEST_CASE(test_stateConstraint_equalArc, data::make(lawTypes), lawType){
	SysData_cr3bp_lt sys("earth", "moon", 500);
	ControlLaw_cr3bp_lt law(lawType, 12e-3, 1500);
...
BOOST_DATA_TEST_CASE(test_endSegCon, data::make(lawTypes), lawType){
	SysData_cr3bp_lt sys("earth", "moon", 500);
	ControlLaw_cr3bp_lt law(lawType, 12e-3, 1500);
...
BOOST_DATA_TEST_CASE(test_endSegCon_equalArc, data::make(lawTypes), lawType){
	SysData_cr3bp_lt sys("earth", "moon", 500);
	ControlLaw_cr3bp_lt law(lawType, 12e-3, 1500);
...
BOOST_DATA_TEST_CASE(test_rmState, data::make(lawTypes), lawType){
	SysData_cr3bp_lt sys("earth", "moon", 14);
	ControlLaw_cr3bp_lt law(lawType, 12e-3, 1500);
...
BOOST_DATA_TEST_CASE(test_rmState_equalArc, data::make(lawTypes), lawType){
	SysData_cr3bp_lt sys("earth", "moon", 14);
	ControlLaw_cr3bp_lt law(lawType, 12e-3, 1500);
...
BOOST_DATA_TEST_CASE(test_continuity, randAlphaGen ^ randBetaGen ^ data::xrange(5), alpha, beta, index){
	(void) index;
...
BOOST_DATA_TEST_CASE(test_stateConstraint, randAlphaGen ^ randBetaGen ^ data::xrange(5), alpha, beta, index){
	(void) index;
