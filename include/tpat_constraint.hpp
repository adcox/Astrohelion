...
enum class TPAT_Constraint_Tp {
	...
	MIN_DIST, 	/*!< Constrain a node to be at or above a specific distance relative
 				 *	to a specific primary. Data is input in the same way as the TPAT_Constraint_Tp::DIST
 				 *	consraint described above.
 				 */
	MAX_DIST,  	/*!< Constrain a node to be at or below a specific distance relative to 
 				 *	specific primary. Data is input in the same way as the TPAT_Constraint_Tp::DIST constraint
 				 *	described above.
 				 */
	...
	DELTA_V,	/*!< Constrain delta V to be exactly the specified amount
 				 *	Data is input in the same format as TPAT_Constraint_Tp::MAX_DELTA_V
 				 */
...
class TPAT_Constraint : public TPAT{
	...
	private:
		...
		TPAT_Constraint_Tp type = TPAT_Constraint_Tp::NONE;		//!< The type of constraint
		TPAT_ConApp_Tp appType = TPAT_ConApp_Tp::APP_TO_NODE;	//!< How this constraint is applied
