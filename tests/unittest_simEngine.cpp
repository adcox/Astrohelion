...
BOOST_AUTO_TEST_CASE(CR3BP_Propagation){
	...
	std::vector<double> initialSegState = traj.getSegByIx(0).getStateByRow(0, 6);	// 6 state variables per row
	std::vector<double> finalSegState = traj.getSegByIx(-1).getStateByRow(-1, 6);
