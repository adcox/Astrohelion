...
class FamGenerator : public Core, public Engine{
	...
	private:
		...
		void cleanEngine();
		void cr3bp_natParamCont(Fam_cr3bp*, Arcset_cr3bp, std::vector<Mirror_tp>, std::vector<unsigned int>, std::vector<unsigned int>, int order = 1);
		...
		bool cr3bp_checkPACSolution(const Arcset_cr3bp*, const MultShootData*, const Eigen::VectorXd&, double, bool*);
};
