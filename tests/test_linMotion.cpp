...
void testEllip(){
	...
	TPAT_Traj_CR3BP traj = engine.getCR3BPLinear(1, r, TPAT_LinMotion_Engine::ELLIP, &sys);
...
void testHyp(){
	...
	TPAT_Sys_Data_CR3BP sys("earth", "moon");
	TPAT_Traj_CR3BP traj = engine.getCR3BPLinear(2, r, TPAT_LinMotion_Engine::HYP, &sys);
...
void testSPO(){
	...
	TPAT_Sys_Data_CR3BP sys("earth", "moon");
	TPAT_Traj_CR3BP traj = engine.getCR3BPLinear(4, r, TPAT_LinMotion_Engine::SPO, &sys);
...
void testLPO(){
	...
	TPAT_Sys_Data_CR3BP sys("earth", "moon");
	TPAT_Traj_CR3BP traj = engine.getCR3BPLinear(5, r, TPAT_LinMotion_Engine::LPO, &sys);
...
void testMPO(){
	...
	TPAT_Sys_Data_CR3BP sys("earth", "moon");
	TPAT_Traj_CR3BP traj = engine.getCR3BPLinear(5, r, TPAT_LinMotion_Engine::MPO, &sys);
...
void testConverge(){
	...
	TPAT_Traj_CR3BP traj = engine.getCR3BPLinear(4, r, TPAT_LinMotion_Engine::CONVERGE, &sys);
